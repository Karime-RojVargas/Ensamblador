...
jne etisal
cmp col,572d
jb etisal ;JB=Jump if Below (Brinca si esta abajo)
cmp col,635d
ja etisal ;JA=Jmp if Above (Brinca si esta arriba)
cmp ren,2d
jb etisal
cmp ren,32d
ja etisal
...
comp1 proc
cmp col,225d
jb pen;JB=Jump if Below (Brinca si esta abajo)
cmp col,248d
ja pen
;JA=Jmp if Above (Brinca si esta arriba)
cmp ren,42d
jb pen
cmp ren,64d
ja pen
...
comp2 proc
cmp col,159d
jb zn;JB=Jump if Below (Brinca si esta abajo)
cmp col,639d
ja zn
;JA=Jmp if Above (Brinca si esta arriba)
cmp ren,35d
